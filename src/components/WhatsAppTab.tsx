  ...
  return (
    <div id="whatsapp-tab-view" className="space-y-6">
      ...
      <div id="whatsapp-integration-section" className="bg-white border border-[#e2e8f0] rounded-xl overflow-hidden shadow-2xs space-y-0 font-sans">
          ...
          <div id="whatsapp-api-config-area" className="bg-slate-50 p-6 border-b border-slate-200">
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <form onSubmit={handleSaveSettings} className="grid grid-cols-1 md:grid-cols-2 gap-5 text-slate-800">
                ...
                <div className="space-y-4">
                  {integrationType === "webhook" ? (
                    <div className="bg-white rounded-xl p-4 border border-slate-150 space-y-3 shadow-2xs">
        ...
        {guideOpen && (
          <div id="technical-integration-guide" className="p-6 bg-slate-50 border-b border-slate-200 text-xs text-slate-650 font-sans leading-relaxed">
            <div className="max-w-4xl mx-auto space-y-5">
              <h4 className="text-sm font-bold text-slate-805 flex items-center gap-1.5 uppercase tracking-wider border-b border-slate-200 pb-2">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-3 rounded-lg border border-slate-150 space-y-2">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <button
                      ...
                      className="text-left w-full p-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 hover:border-slate-350 rounded-md text-[10.5px] text-slate-700 font-semibold transition cursor-pointer flex items-center justify-between"
                    >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-shrink-0 p-1.5 px-2 rounded-lg bg-slate-100 text-slate-650 hover:bg-slate-200 border border-slate-300 transition cursor-pointer text-[10.5px]"
