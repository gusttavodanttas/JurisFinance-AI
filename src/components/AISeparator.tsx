        ...
        <div className="flex flex-wrap gap-2 items-center justify-between">
          <div className="flex gap-2">
            <button
              ...
              className="text-[10px] bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-350 px-2.5 py-1.5 rounded font-semibold flex items-center gap-1 transition-all cursor-pointer"
            >
                    ...
                    <td className="p-3">
                      <span className={`inline-block px-2 py-0.5 rounded-full text-[9px] font-bold border ${
                        item.scope === TransactionScope.PROFESSIONAL
                          ? "bg-indigo-500/10 text-indigo-300 border-indigo-550/20"
