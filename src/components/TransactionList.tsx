...
export default function TransactionList({
  ...
  // Get distinct list of available months in transactions
    ...
    <div id="financial-journal-panel" className="bg-white rounded-lg border border-[#e2e8f0] p-4 shadow-2xs">
      ...
      <div id="filter-controls-row" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 bg-slate-50 p-3 rounded-lg mb-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            type="text"
            className="w-full bg-white border border-slate-200 rounded py-1.5 pl-8 pr-2.5 text-xs placeholder-slate-400 focus:outline-hidden focus:border-[#8b5cf6] text-slate-705"
        ...
        <div className="flex items-center gap-1.5 bg-white border border-slate-200 rounded px-2 py-1.5">
          ...
          <select
            ...
            className="w-full bg-transparent text-xs text-slate-650 focus:outline-hidden cursor-pointer font-bold uppercase tracking-wide"
            value={scopeFilter}
            onChange={(e) => {
        ...
        <div className="flex items-center gap-1.5 bg-white border border-slate-200 rounded px-2 py-1.5 animate-fade-in">
          ...
          <select
            ...
            className="w-full bg-transparent text-xs text-slate-650 focus:outline-hidden cursor-pointer font-bold uppercase tracking-wide truncate"
      ...
      <div id="filter-metrics-summary" className="grid grid-cols-2 md:grid-cols-4 gap-2.5 bg-slate-50/40 p-2.5 rounded mb-4 text-[10px] border border-[#e2e8f0]">
        ...
        <div>
          ...
          <span className="text-violet-750 font-bold font-mono block text-xs mt-0.5">{formatCurrency(filteredPersRevenue)}</span>
        </div>
        <div>
