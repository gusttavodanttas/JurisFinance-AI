...
import { Printer, CalendarDays, FileSpreadsheet, Percent, Scale, TrendingUp, Sparkles, Building2 } from "lucide-react";
...
export default function MonthlyReport({ transactions, selectedMonth }: MonthlyReportProps) {
