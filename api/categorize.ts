...
7. Fornecer de forma objetiva um nível de confiança da sua decisão (0 a 100) e uma justificativa ("reason") em português explicando a lógica empregada (Ex: "Identificado como despesa de escritório devido ao pagamento de software jurídico").
      ...
      config: {
        ...
        responseSchema: {
          ...
          items: {
            ...
            required: ["date", "description", "type", "scope", "category", "amount", "confidence", "reason"],
          },
        },
      },
    });
